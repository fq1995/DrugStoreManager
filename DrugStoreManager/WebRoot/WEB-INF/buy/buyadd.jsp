		...
		<form action="buy_addBuy.action" method="post">
			...
			<ul class="forminfo">
				<li><label>采购单编号</label><input name="drugbuyCode" type="text"
					id="drugCode" value="${requestScope.drugbuyCode }"
				...
				<li><label>剂型</label> <select class="form-control"
					...
					name="drugBean.dosageformBean.dosageformId">
				...
				<li><label>单位</label> <select class="form-control"
					style="width: 200px; height: 34px" name="drugBean.drugUnitBean.unitnameId">
						<option value="">请选择</option>
				...
				<li><label>类别</label> <select class="form-control"
					style="width: 200px; height: 34px"
					name="drugBean.drugCategoryBean.categoryId">
						<option value="">请选择</option>
				...
				<li><label>采购数量</label><input name="mount" type="text"
					id="mount" class="form-control" value="100"
