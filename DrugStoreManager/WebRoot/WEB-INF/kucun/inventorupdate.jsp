...
<body>
	...
	<div class="formbody">
		...
		<form action="inventor_updateInventor.action" method="post">
			...
			<input type="hidden" name="date" value="${inventor.date }">
			<input type="hidden" name="drugBean.modifyTime" value="${inventor.drugBean.modifyTime }">
			<input type="hidden" name="drugBean.drugId" value="${inventor.drugBean.drugId }">
			<input type="hidden" name="stockId" value="${inventor.stockId }">

			<ul class="forminfo">
				<li><label>库存单编号</label><input name="stockCode" type="text" id="stockCode" readonly="readonly" value="${inventor.stockCode }"
					class="form-control" style="width:200px; display:inline" placeholder="请输入库存单编号" /><i>必填</i></li>
				<li><label>药品编号</label><input name="drugBean.drugCode" type="text" id="drugCode" readonly="readonly" value="${inventor.drugBean.drugCode }"
					class="form-control" style="width:200px; display:inline" placeholder="请输入药品编号" /><i>必填</i><i style="color: red">${message2}</i></li>
				<li><label>药品名</label><input name="drugBean.drugName" type="text" id="drugName" value="${inventor.drugBean.drugName }"
				...
				<li><label>修改人</label><input name="drugBean.modifier" type="text" id="modifier" value="${inventor.drugBean.modifier }" readonly="readonly"
					class="form-control" style="width:200px; display:inline" placeholder="请输入修改人"/><i></i></li>
				<li><label>库存数量</label><input name="drugBean.stocknumber" type="text" id="stocknumber" value="${inventor.drugBean.stocknumber }"
