...
<body>
	...
	<div class="formbody">
		...
		<form action="member_updateMember.action" method="post">
		...
		<ul class="forminfo">
				...
				<li><label>性别</label><cite>
					<input name="sex" type="radio" value="1" checked="checked"<c:if test="${member.sex }==1"> checked="checked"</c:if> />男&nbsp;&nbsp;&nbsp;&nbsp;
					<input name="sex" type="radio" value="0" <c:if test="${member.sex }==0"> checked="checked"</c:if> />女</cite></li>
				<li ><label>年龄</label><input name="age" type="text" id="age" value="${member.age}"
					class="form-control" style="width:200px; display:inline" placeholder="请输入年龄"/></li>
				<li ><label>电话</label><input name="suppliertel" type="text" id="suppliertel" value="${member.suppliertel}"
				...
				<li ><label>地址</label><input name="address" type="text" id="address" value="${member.address}"
					class="form-control" style="width:200px; display:inline" placeholder="请输入地址"/></li>
				<li ><label>会员等级</label><input name="memberLevel" type="text" id="memberLevel" value="${member.memberLevel}"
