...
public class UserDAOImpl extends BaseDAO<UserBean> implements UserDAO {
	...
	public PageModel<UserBean> splitUser(Integer currPage, Integer pageSize,String keyword) {
		String hql_count = "select count(*) from UserBean where type not in ('4','5') and username like :keyword";
		String hql = "from UserBean where type not in ('4','5') and username like :keyword order by userCode desc";
	...
	public List<UserBean> show() {
		String hql ="from UserBean where type not in ('4','5') ";
